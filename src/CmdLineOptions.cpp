...
namespace liteg
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "litblocks, Onion Bitlitas Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable Bitlitas total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.bitlitas/lmdb")
                ("ssl-crt-file", value<string>(),
                 "path to crt file for ssl (https) functionality")
                ("ssl-chain-file", value<string>(),
                 "path to chain file for ssl (https) functionality")
