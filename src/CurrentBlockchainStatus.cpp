...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = liteg::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.bitlitas/lmdb"};
...
liteg::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
